...
if __name__ == "__main__":
    ...
    input_data_paths = ["/opt/ml/processing/input"]
    ...
    train_files = filenames[:int(train_ration*len(filenames))]
    val_files = filenames[int(train_ration*len(filenames)): int(train_ration*len(filenames)) + int(val_test_ratio*len(filenames))]
